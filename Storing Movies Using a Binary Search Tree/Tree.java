...
public interface Tree <E>
{
    ...
    /**
     * Method printInOrder() Prints the tree using inorder traversal to a file
     */
    void printInOrder();
    
    /**
     * Method writeInOrder() prints the tree using inorder traversal to a file
     * @param fileName the name of the file to print to
     */
    void writeInOrder(String fileNmae);
